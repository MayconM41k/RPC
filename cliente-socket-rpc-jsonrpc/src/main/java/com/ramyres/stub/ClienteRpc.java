...
public class ClienteRpc {
    ...
    public static String[] executar(String method, String[] params) {
        ...
        if (res == null) {
            throw new RuntimeException("Não foi possível conectar ao servidor. Certifique-se de que o Servidor (Main.java do servidor) está rodando antes de fazer o pedido!");
        }
        if (res.error != null) {
