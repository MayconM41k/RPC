...
public class UserInterfaceTui {
    ...
    private void callPalavrasService(Scanner scanner) {
        System.out.println("Digite o texto para analisar:");
        scanner.nextLine(); // Limpar o buffer
        String texto = scanner.nextLine();

        System.out.println("Calculando as estatísticas do texto...");
        
        com.ramyres.servicos.PalavrasService palavrasService = new com.ramyres.servicos.PalavrasService();
        com.ramyres.model.EstatisticaDoTexto result = palavrasService.ObterEstatistica(texto);
        
        System.out.println("Estatísticas do Texto:");
        System.out.println("Letras: " + result.qtdLetras);
        System.out.println("Palavras: " + result.qtdPalavras);
        System.out.println("Vogais: " + result.qtdVogal);
        System.out.println("Vogais Acentuadas: " + result.qtdVogalAcentuada);
        System.out.println("Consoantes: " + result.qtdConsoantes);
        System.out.println("Espaços: " + result.qtdEspacos);
        System.out.println("Palavras com tamanho par: " + result.qtdPalavrasPar);
        System.out.println("Palavras com tamanho ímpar: " + result.qtdPalavrasImpar);
        System.out.println("Linhas: " + result.qtdDeLinhas);
    }
